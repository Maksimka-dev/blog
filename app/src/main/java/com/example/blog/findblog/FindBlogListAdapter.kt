...
class FindBlogListAdapter   (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FindBlogListAdapter.ViewHolder {
        val binding = ChannelFindblogBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return FindBlogListAdapter.ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: FindBlogListAdapter.ViewHolder, position: Int) {
